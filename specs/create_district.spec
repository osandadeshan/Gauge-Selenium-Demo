...
* Create and submit district using district name as <District Name>, address as <Address>, email domain as <Email Domain>, security realam as <Realam>, first name as <FirstName>, last name as <LastName> and emp no as <EMP No>
